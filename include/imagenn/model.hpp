...
class Model {
  public:
    ...
    /// \param[in] layer слой свёртки, подвыборки или выпрямления
    ...
    /// \param[in] data параметры по слоям в порядке слоёв
    /// \throw ValidationError если число слоёв не совпадает
