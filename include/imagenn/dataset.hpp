...
/// Если средняя яркость выше 0.5 (светлый фон, тёмная цифра), цвета инвертируются,
/// чтобы привести изображение к формату обучающих данных MNIST: светлая цифра на
/// тёмном фоне.
