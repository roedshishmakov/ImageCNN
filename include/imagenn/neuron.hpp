...
class Neuron {
  public:
    ...
    /// \param[in] signal входной сигнал
    void add(double signal) { input_ += signal; }

    /// \brief Сбрасывает вход нейрона.
    /// \param[in] input новое значение входа
    ...
    /// \param[in] ref эталонное значение
    ...
    /// \param[in] value новое значение выхода
...
class TransparentNeuron : public Neuron {
  public:
    ...
    /// \param[in] activation функция активации
...
class BiasNeuron : public Neuron {
  public:
    ...
    /// \param[in] input не используется
