...
class Link {
  public:
    ...
    /// \param[in] from нейрон-источник
    /// \param[in] to нейрон-приёмник
    /// \param[in] weight начальный вес связи
    ...
    /// \param[in] signal передаваемый сигнал
    ...
    /// \param[in] value сохранённый вес
