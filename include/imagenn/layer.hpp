...
class Layer {
  public:
    ...
    /// \param[in] type тип нейронов слоя
    /// \param[in] size количество нейронов
    /// \param[in] activation функция активации нейронов
    ...
    /// \param[in] input значения входов; длина должна совпадать с размером слоя
    /// \throw ValidationError если длина input не равна размеру слоя
    ...
    /// \param[in] refs эталонные значения
    /// \return значение потери (квадратичная ошибка)
    /// \throw ValidationError если длина refs не равна размеру слоя
    ...
    /// \param[in] data веса каждого нейрона
    /// \throw ValidationError если число нейронов не совпадает
...
class LayerSoftmax : public Layer {
  public:
    ...
    /// \param[in] refs эталонное распределение
